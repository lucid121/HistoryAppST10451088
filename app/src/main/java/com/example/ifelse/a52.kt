...
class a52 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a52)
        ...
        textContent = arrayOf(
            "You are 61, the same age as when Muhammad, the Islamic prophet, passed away. Muhammad's life and teachings had a profound impact on the world. He founded Islam, a monotheistic religion that now has over a billion followers. His leadership, moral teachings, and the Quran continue to shape the lives of millions of people globally⁶."
        )
