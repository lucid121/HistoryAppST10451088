...
class a24 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 33 the same age as when Theodore Gericault died. Theodore Gericault, a French Romantic artist, is renowned for his powerful and emotive paintings. His masterpiece, “The Raft of the Medusa,” depicts the survivors of a shipwreck adrift and starving on a raft. Through this harrowing work, Gericault captured individual suffering and tragedy, addressing contemporary themes of survival, despair, and human resilience."
        )
