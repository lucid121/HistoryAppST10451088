...
class a60 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a60)
        ...
        textContent = arrayOf(
            "You are 69, the same age as when Louis Armstrong died. Louis Armstrong, a legendary jazz trumpeter and vocalist, left an indelible mark on music. Born in New Orleans, he pioneered jazz improvisation, influencing countless musicians. His gravelly voice and iconic trumpet solos continue to resonate globally, shaping the very essence of jazz and popular music."
        )
