...
class a31 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 40 the same age as when Franz Kafka died. Franz Kafka, a German-speaking Bohemian Jewish novelist, remains a major figure in 20th-century literature. His works blend realism and the fantastic, exploring themes of alienation, guilt, and absurdity. “The Metamorphosis” and “The Trial” are among his best-known works, and the term “Kafkaesque” now describes situations marked by surreal predicaments and bureaucratic powers."
        )
