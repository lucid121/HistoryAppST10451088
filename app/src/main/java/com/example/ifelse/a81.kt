...
class a81 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a81)
        ...
        textContent = arrayOf(
            "You are 90, the same age as when Alice Coachman died. Alice Coachman was an American athlete who made history by becoming the first Black woman to win an Olympic gold medal. In the 1948 London Olympics, she leaped 5 feet 6 1/8 inches (1.68 m) in the high jump, securing her place in the record books. Her victory shattered barriers and inspired generations of athletes, highlighting the resilience and determination of African American women in sports1."
        )
