...
class a62 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a62)
        ...
        textContent = arrayOf(
            "You are 71, the same age as when George Carlin, the irreverent comedian and social critic, left us. Carlin fearlessly challenged societal norms through his stand-up routines. His sharp wit dissected language, politics, and culture, pushing boundaries and provoking thought. His legacy endures as a beacon of free expression and satire."
        )
