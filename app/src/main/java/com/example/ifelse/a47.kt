...
class a47 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a47)
        ...
        textContent = arrayOf(
            "You are 56, the same age as when Steve Jobs died. Jobs co-founded Apple Inc. and revolutionized personal computing, music, and communication. His vision gave birth to iconic products like the iPhone, iPad, and Macintosh. Jobs was not only a tech visionary but also a master storyteller, emphasizing design, simplicity, and user experience. His legacy continues to shape the digital landscape, inspiring innovation and creativity."
        )
