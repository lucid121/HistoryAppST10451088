...
class a82 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a82)
        ...
        textContent = arrayOf(
            "You are 91, the same age as when Pablo Picasso died. Pablo Picasso, the Spanish artist, was a pioneer of Cubism, alongside Georges Braque. His radical approach to representation transformed art by acknowledging the illusionistic tricks required to depict three-dimensional objects on a flat canvas. Cubism changed the way people thought about art, ushering in abstract movements of the 20th century. Picasso’s versatility in capturing hard-hitting news, feature stories, and fashion collections made him indispensable to his editors and readers, representing a more complex view of reality and communicating difficult truths to a mainstream audience2."
        )
