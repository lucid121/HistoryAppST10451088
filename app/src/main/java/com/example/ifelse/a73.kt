...
class a73 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a73)
        ...
        textContent = arrayOf(
            "You are 82, the same age as when Neil Armstrong left this world. Armstrong etched his name in history as the first person to set foot on the moon during the Apollo 11 mission in 1969. His iconic words, That's one small step for [a] man, one giant leap for mankind, resonated across the globe. Armstrong's achievement symbolized humanity's boundless curiosity and our ability to explore the cosmos."
        )
