...
class a44 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a44)
        ...
        textContent = arrayOf(
            "You are 53, the same age as when Vladimir Lenin died. Lenin was a revolutionary leader who played a pivotal role in the Russian Revolution of 1917. As the founder of the Soviet Union, he implemented radical changes, including land redistribution and the establishment of a communist state. His vision and ideology shaped the course of the 20th century, leaving an enduring impact on global politics."
        )
