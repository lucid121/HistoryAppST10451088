...
class a28 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 37 the same age as when Vincent van Gogh died. Vincent van Gogh, a Dutch post-Impressionist painter, left an indelible mark on art history. His dramatic use of color, bold brushwork, and emotional intensity transformed the art world. Despite personal struggles and mental health challenges, van Gogh’s legacy endures through masterpieces like The Starry Night and Sunflowers."
        )
