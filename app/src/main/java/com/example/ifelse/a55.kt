...
class a55 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a55)
        ...
        textContent = arrayOf(
            "You are 64, the same age as when Karl Marx died. Marx was a German philosopher, economist, and political theorist. His ideas on communism and **socialism** have had a lasting impact on the world. His work, including The Communist Manifesto and Das Kapital, continues to influence political thought and economic theory."
        )
