...
class a72 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a72)
        ...
        textContent = arrayOf(
            "You are 81, the same age as when Winnie Mandela passed away. Winnie Mandela, a prominent anti-apartheid activist and politician, played a crucial role in the struggle against racial segregation in South Africa. She was married to Nelson Mandela, the iconic leader who fought for equality and justice. Despite facing imprisonment and persecution, Winnie remained steadfast in her commitment to the cause, inspiring generations with her resilience and dedication to freedom and human rights."
        )
