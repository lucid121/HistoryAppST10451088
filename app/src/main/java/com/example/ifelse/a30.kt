...
class a30 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 39 the same age as when Martin Luther King Jr died. Martin Luther King Jr., a Baptist minister and civil rights activist, led the fight against racial segregation in the United States. His commitment to nonviolent protest, eloquent speeches, and tireless advocacy played a pivotal role in ending legal discrimination. His legacy lives on, inspiring movements for justice and equality globally."
        )
