...
class a67 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a67)
        ...
        textContent = arrayOf(
            "You are 76, the same age as when Albert Einstein, the brilliant physicist, left us. Einstein's theory of relativity revolutionized our understanding of space, time, and gravity. His scientific contributions, including the famous E=mc² equation, continue to shape modern physics."
        )
