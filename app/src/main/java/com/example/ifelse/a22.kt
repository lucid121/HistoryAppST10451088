...
class a22 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 30, the same age as when George’s Seurat died, a French painter, is chiefly remembered as the pioneer of the Neo-Impressionist technique commonly known as Pointillism. His innovative approach involved using tiny brushstrokes of contrasting colors to create shimmering, luminous compositions. Notable works include “Bathers at Asnières” and “A Sunday on La Grande Jatte—1884.” Seurat’s influence extended beyond his lifetime, shaping the Hellenistic world of territorial kingdoms12."
        )
