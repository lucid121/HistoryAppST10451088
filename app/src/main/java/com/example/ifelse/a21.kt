...
class a21 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 30, the same age as when Steve Biko died. Steve Biko was a South African anti-apartheid activist and founder of the Black Consciousness Movement. His dedication to fighting racial segregation and promoting Black pride made him a martyr for the struggle against apartheid. His legacy continues to inspire human rights movements globally.."
        )
