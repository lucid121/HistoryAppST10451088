...
class a76 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a76)
        ...
        textContent = arrayOf(
            "You are 85, the same age as when Elijah McCoy departed. McCoy, a Canadian-American engineer and inventor, is best known for his automatic lubrication system for steam engines. His invention significantly improved machinery efficiency and safety. The phrase the real McCoy originated from the high quality of his inventions, emphasizing their authenticity and reliability."
        )
