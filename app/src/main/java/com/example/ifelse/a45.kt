...
class a45 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a45)
        ...
        textContent = arrayOf(
            "You are 54, the same age as when Christopher Columbus died. Columbus, the intrepid explorer, embarked on transformative voyages that connected the Old World and the New World. His expeditions opened up new horizons, leading to cultural exchange, trade, and colonization. While his legacy is complex, Columbus remains a central figure in the age of exploration and the clash of civilizations."
        )
