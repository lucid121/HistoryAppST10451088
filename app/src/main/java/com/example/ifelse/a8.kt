...
class a8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 17, the same age as when Lady Jane Grey died. Lady Jane Grey was briefly the queen of England for just nine days in 1553. Her reign was marked by political turmoil and religious conflict. Despite her short rule, she left a lasting impact as a symbol of Protestant resistance and the struggle for religious freedom."
        )
