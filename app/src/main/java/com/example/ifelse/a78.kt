...
class a78 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a78)
        ...
        textContent = arrayOf(
            "You are 87, the same age as when Helen Keller departed. Keller, despite being deaf and blind from an early age, became an influential writer, lecturer, and advocate. Her determination and connection with her teacher, Anne Sullivan, allowed her to overcome immense challenges. Keller's life story exemplifies the triumph of the human spirit and the importance of education and empathy."
        )
