...
class a79 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a79)
        ...
        textContent = arrayOf(
            "You are 88, the same age as when Michelangelo left this mortal realm. Michelangelo, the renowned Italian Renaissance artist, sculptor, and painter, created masterpieces like the Sistine Chapel ceiling and the statue of David. His contributions to art and architecture continue to inspire awe and admiration, reflecting the timeless pursuit of beauty and creativity."
        )
