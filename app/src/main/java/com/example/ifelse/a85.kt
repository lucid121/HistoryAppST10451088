...
class a85 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a85)
        ...
        textContent = arrayOf(
            "You are 94, the same age as when Nancy Reagan died. Nancy Reagan, the American first lady from 1981 to 1989, was known for her efforts to discourage drug use by American youths. She launched the famous “Just Say No” anti-drug campaign, touring the country to give speeches and visit rehabilitation centers. Her advocacy helped raise awareness about substance abuse and its impact on young people. Beyond her role as first lady, Nancy remained a devoted champion for peace and social justice until her passing in 201667."
        )
