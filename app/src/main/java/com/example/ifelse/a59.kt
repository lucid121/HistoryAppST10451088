...
class a59 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a59)
        ...
        textContent = arrayOf(
            "You are 68, the same age as when Jack Johnson, the legendary boxer, passed away. Jack Johnson was the first African-American world heavyweight boxing champion. His victories in the ring challenged racial barriers and inspired generations of athletes. Johnson's legacy extends beyond sports, as he fought against racism and paved the way for future civil rights leaders³¹."
        )
