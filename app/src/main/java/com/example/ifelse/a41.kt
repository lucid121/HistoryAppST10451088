...
class a41 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 50, the same age as when Chris Hani died. Hani was a courageous anti-apartheid activist in South Africa. As the leader of the South African Communist Party, he played a pivotal role in the struggle against apartheid. His assassination in 1993 shocked the nation and underscored the challenges faced by those fighting for justice and equality. Hani’s legacy continues to inspire generations, reminding us of the sacrifices made for freedom and human rights."
        )
