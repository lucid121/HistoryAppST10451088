...
class a48 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 57, the same age as when Mustafa Kemal Atatürk died. Atatürk, the founder of modern Turkey, led the country through a remarkable transformation. His reforms included secularism, education, and women’s rights. Atatürk’s vision for a modern, progressive Turkey remains influential, even decades after his passing. His legacy stands as a testament to the power of leadership and nation-building."
        )
