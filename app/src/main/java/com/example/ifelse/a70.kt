...
class a70 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a70)
        ...
        textContent = arrayOf(
            "You are 79, the same age as when Alexander Crummell, an influential African-American scholar and priest, left this world. Crummell championed education, racial uplift, and self-reliance. His writings and activism paved the way for future civil rights leaders."
        )
