...
class a46 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a46)
        ...
        textContent = arrayOf(
            "Julius Caesar (55): You are 55, the same age as when Julius Caesar died. Caesar’s name echoes through the annals of ancient Rome. A military general, statesman, and author, he played a pivotal role in the transformation of the Roman Republic into an empire. His assassination on the Ides of March in 44 BCE marked a turning point in history, leading to political upheaval and the rise of Augustus. The phrase “Et tu, Brute?” immortalizes the betrayal that sealed his fate."
        )
