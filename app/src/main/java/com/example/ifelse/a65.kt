...
class a65 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 74, the same age as when Muhammad Ali, the boxing legend, passed away. Ali's charisma, athleticism, and unwavering principles made him a global icon. Beyond the ring, he championed civil rights, religious freedom, and humanitarian causes. His legacy transcends sports, inspiring generations."
        )
