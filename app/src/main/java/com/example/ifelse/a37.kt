...
class a37 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 46, the same age as when John F. Kennedy died. JFK, the 35th president of the United States, faced foreign crises during the Cold War but secured achievements like the Nuclear Test-Ban Treaty and the Alliance for Progress. His powerful speeches, charisma, and vision captivated the nation. His assassination in 1963 shocked the world and left a legacy of leadership and inspiration."
        )
