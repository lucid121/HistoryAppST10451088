...
class a58 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a58)
        ...
        textContent = arrayOf(
            "You are 67, the same age as when Leonardo da Vinci died. Da Vinci was an Italian artist, engineer, and inventor. His contributions to art, science, and anatomy were groundbreaking. His works, including Mona Lisa and The Last Supper, continue to captivate audiences worldwide."
        )
