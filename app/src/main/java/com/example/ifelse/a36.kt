...
class a36 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 45, the same age as when Olympe de Gouges died. Olympe de Gouges was a French writer and activist who challenged conventional views on women’s rights and abolitionism. She is best known for her “Declaration of the Rights of Woman and of the Female Citizen.” Her humanity, personal struggles, and fabulous camp style made her an icon to the gay community. Her courage in advocating for equal rights continues to inspire generations."
        )
