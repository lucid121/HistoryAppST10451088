...
class a10 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 19, the same age as when Joan of Arc died. Joan of Arc, also known as the Maid of Orléans, was a French heroine during the Hundred Years’ War. She believed she was guided by divine voices and led the French army to victory at Orléans. Her courage and determination made her a symbol of French patriotism and national pride."
        )
