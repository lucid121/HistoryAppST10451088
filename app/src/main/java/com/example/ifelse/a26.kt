...
class a26 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 35 the same age as when Sir William Wallace died. Sir William Wallace, a Scottish knight and national hero, led the fight for Scotland’s independence from England. His victory against a larger English army at the Battle of Stirling Bridge in 1297 remains legendary. Wallace’s courage, determination, and sacrifice continue to symbolize Scotland’s struggle for freedom."
        )
