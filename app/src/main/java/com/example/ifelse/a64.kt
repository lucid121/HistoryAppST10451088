...
class a64 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a64)
        ...
        textContent = arrayOf(
            "You are 73, the same age as when the Godfather of Soul, James Brown, left the stage. Brown's electrifying performances and hits like I Got You (I Feel Good) and Papa's Got a Brand New Bag transformed rhythm and blues. His impact on funk, soul, and dance music is immeasurable."
        )
