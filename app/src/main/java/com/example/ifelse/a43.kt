...
class a43 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a43)
        ...
        textContent = arrayOf(
            "You are 52, the same age as when William Shakespeare died. The Bard of Avon, as he is affectionately known, left an indelible mark on literature. His plays, sonnets, and poems continue to captivate audiences worldwide. From the tragic romance of “Romeo and Juliet” to the existential musings of “Hamlet,” Shakespeare’s timeless themes resonate across centuries. His eloquence and insight into the human condition remain unparalleled."
        )
