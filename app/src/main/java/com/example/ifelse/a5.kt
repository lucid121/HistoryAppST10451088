...
class a5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 14, the same age as when George Stinney died. George Stinney was a tragic figure in American history. In 1944, at the age of 14, he was executed in South Carolina, becoming the youngest person in the United States to face capital punishment. His trial was deeply flawed, and it took 70 years for him to be exonerated. His case highlights the injustices faced by African Americans during the Jim Crow era.."
        )
