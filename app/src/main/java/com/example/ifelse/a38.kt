...
class a38 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a38)
        ...
        textContent = arrayOf(
            "You are 47, the same age as when Judy Garland died. Judy Garland, an American singer and actress, achieved fame early on. Her role as Dorothy in “The Wizard of Oz” made her an icon. Her powerful vocals and emotional performances touched hearts worldwide. Despite personal struggles, she remains one of the greatest artists in music history."
        )
