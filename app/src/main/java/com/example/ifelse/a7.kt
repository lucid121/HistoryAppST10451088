...
class a7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 15, the same age as when Edward VI died. Edward VI, the son of Henry VIII, ruled England and Ireland from 1547 to 1553. Despite his short reign, he made significant contributions. Edward reversed his father’s religious reforms, restoring worship of the god Amun and strengthening Protestantism. His legacy lies in his impact on the English Reformation."
        )
