...
class a16 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 25, the same age as when Tupac Shakur died. Tupac Shakur, also known as 2Pac, was an influential American rapper, actor, and poet. His lyrics addressed social issues, racism, and inequality. His death in a drive-by shooting in 1996 shocked fans worldwide, and he remains an icon in hip-hop culture."
        )
