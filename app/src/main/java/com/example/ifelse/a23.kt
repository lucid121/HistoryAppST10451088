...
class a23 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 32 the same age as when Alexander the great died. an ancient Macedonian ruler, is one of history’s greatest military minds. As King of Macedonia and Persia, he established the largest empire the ancient world had ever seen. Charismatic, brilliant, and ruthless, Alexander inspired unwavering loyalty in his men. His conquests stretched from Greece to Egypt and India, leaving an enduring legacy. His influence on Greek and Asian culture ushered in the Hellenistic Period345."
        )
