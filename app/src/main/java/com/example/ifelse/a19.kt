...
class a19 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 28, the same age as when **Caligula** died. Caligula, formally known as Gaius, was the third Roman emperor. His reign (A.D. 37-41) was marked by extravagance, cruelty, and madness. He altered the course of Roman history and became infamous for his excesses and erratic behavior."
        )
