...
class a27 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 36 the same age as when Marilyn Monroe died. Marilyn Monroe, an iconic American actress, captivated audiences with her beauty, talent, and vulnerability. Beyond her glamorous image, Monroe faced personal struggles and societal pressures. Her tragic death at the age of 36 immortalized her as a cultural icon, representing both Hollywood allure and the complexities of fame."
        )
