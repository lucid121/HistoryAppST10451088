...
class a13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 22, the same age as when Aaliyah died. Aaliyah was a talented American singer, actress, and model. She achieved success at a young age with hits like Try Again and Are You That Somebody? Her untimely death in a plane crash in 2001 shocked the music industry. Aaliyah's influence continues to be felt in R&B and hip-hop music."
        )
