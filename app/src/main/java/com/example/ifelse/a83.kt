...
class a83 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 92, the same age as when Rosa Parks died. Rosa Parks was a pivotal figure in the American civil rights movement. In 1955, she refused to give up her seat to a white man on a Montgomery, Alabama bus, sparking the Montgomery Bus Boycott. Her actions led to the end of bus segregation and ignited the broader civil rights movement. Parks became a symbol of dignity and strength, advocating for an end to racial segregation and inspiring generations to fight for justice and equality34."
        )
