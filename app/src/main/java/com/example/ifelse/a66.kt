...
class a66 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a66)
        ...
        textContent = arrayOf(
            "You are 75, the same age as when Augustus, Rome's first emperor, breathed his last. Augustus, born Gaius Octavius, transformed the Roman Republic into an empire. His reign brought stability, infrastructure, and cultural flourishing, shaping the Pax Romana era."
        )
