...
class a34 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 43, the same age as when Johannes Vermeer died. Vermeer was a 17th-century Dutch painter known for his luminous paintings of daily life, allegorical scenes, and cityscapes. Although only about 36 of his paintings survive, including “Girl with a Pearl Earring,” these rare works are among the greatest treasures in the world’s finest museums. Vermeer’s mastery of pigment and light elevated him beyond his contemporaries, providing an inimitable glimpse into the lifestyle of his thriving historical era."
        )
