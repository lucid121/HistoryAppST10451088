...
class a71 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a71)
        ...
        textContent = arrayOf(
            "You are 80, the same age as when Ethel Waters, the trailblazing singer, actress, and blues artist, bid farewell. Waters broke barriers as one of the first African-American women to achieve mainstream success in entertainment. Her powerful voice and resilience continue to inspire artists and audiences alike."
        )
