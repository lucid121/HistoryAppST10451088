...
class a86 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a86)
        ...
        textContent = arrayOf(
            "You are 95, the same age as when Nelson Mandela died. Nelson Mandela was a Black nationalist and the first Black president of South Africa (1994–99). His negotiations with President F.W. de Klerk helped end apartheid, and he became a global advocate for human rights. Mandela’s resilience during nearly three decades of imprisonment and his commitment to peaceful transition made him an iconic figure in the fight against racial oppression. His legacy continues to inspire movements for justice and equality worldwide"
        )
