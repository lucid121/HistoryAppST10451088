...
class a75 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a75)
        ...
        textContent = arrayOf(
            "You are 84, the same age as when **Thomas Edison** left this earthly plane. Edison, the prolific inventor, held over a thousand patents. His most famous invention, the practical electric light bulb, illuminated the world and transformed daily life. Beyond lighting, Edison's contributions spanned telegraphy, motion pictures, and sound recording, leaving an indelible mark on technological progress."
        )
