...
class a69 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a69)
        ...
        textContent = arrayOf(
            "You are 78, the same age as when Mahatma Gandhi, the nonviolent leader of India's independence movement, passed away. Gandhi's philosophy of Satyagraha inspired civil rights movements worldwide. His tireless advocacy for justice, equality, and peace remains an enduring legacy."
        )
