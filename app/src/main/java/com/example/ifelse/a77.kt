...
class a77 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a77)
        ...
        textContent = arrayOf(
            "You are 86, the same age as when Sojourner Truth passed away. Truth was a remarkable abolitionist, women's rights advocate, and powerful orator. Born into slavery, she escaped to freedom and dedicated her life to fighting for justice. Her famous Ain't I a Woman? speech challenged gender and racial inequalities, leaving an enduring legacy in the struggle for civil rights."
        )
