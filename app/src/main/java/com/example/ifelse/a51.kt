...
class a51 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 60, the same age as when Ira Aldridge died. Ira Aldridge was a trailblazing African-American actor who became one of the most celebrated Shakespearean actors in history. Born in New York in 1807, he settled in Europe and broke barriers by playing Othello in Britain, becoming the first Black man to do so. His life and career highlighted racial attitudes in the 19th century and inspired future generations of artists and activists."
        )
