...
class a63 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a63)
        ...
        textContent = arrayOf(
            "You are 72, the same age as when Herman Melville, the literary giant, departed. Melville's masterpiece, Moby-Dick, explored themes of obsession, fate, and the human condition. His seafaring tales captured the essence of 19th-century America, and his influence on literature remains profound."
        )
