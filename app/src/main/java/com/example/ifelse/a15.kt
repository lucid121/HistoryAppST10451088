...
class a15 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 25, the same age as when Patrick Hamilton died. Patrick Hamilton was a Scottish Reformation martyr who challenged the Roman Catholic Church's teachings. His courage in advocating for religious reform and his commitment to the Bible's message left a lasting impact on Scotland's history."
        )
