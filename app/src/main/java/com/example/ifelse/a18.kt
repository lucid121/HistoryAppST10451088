...
class a18 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textContent = arrayOf(
            "You are 27, the same age as when Jimi Hendrix died. Jimi Hendrix was an American rock guitarist, singer, and composer. His innovative style redefined the electric guitar, and his songs like Purple Haze and The Wind Cries Mary remain iconic. His death in 1970 from a drug overdose was a tragic loss for music."
        )
